import { SendrepairService } from './../sendrepair/sendrepair.service';
...
@Component({
  ...
  styleUrls: ['./sendrepair-detail.component.scss']
})
export class SendrepairDetailComponent implements OnInit {
  transfer_docno: any;
  repairs: any;
  detail: any;
  imgUrl: any = '';
  ...
  getSendrepair() {
    ...
    this.sendrepairService.getSendrepair(this.transfer_docno).subscribe((data: any) => {
